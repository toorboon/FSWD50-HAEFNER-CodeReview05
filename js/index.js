...
class Locations {
    constructor(loc_type, name, city, zip, address, img_src) {
...
class Restaurant extends Locations {
    constructor(loc_type, name, city, zip, address, img_src, phone, phone_type, url) {
...
class Events extends Locations {
    constructor(loc_type, name, city, zip, address, img_src, event_date, event_location, ticket_price) {
        super(loc_type, name, city, zip, address, img_src);
